...
def main():
    ...
    # with open("sample/sample21.txt") as f:
        codes = f.read().splitlines()
        print(codes)
    print("Part1:",sum(int(code[:-1]) * find_shortest_sequence(code, proxies=2) for code in codes))
    print("Part2:",sum(int(code[:-1]) * find_shortest_sequence(code, proxies=25) for code in codes))
