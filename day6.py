...
if __name__ == "__main__":
    print("Part 1 example", day06_part1("sample/sample6.txt"))
    print("Part 1", day06_part1("input/input6.txt"))
    print("Part 2 example", day06_part2("sample/sample6.txt"))
    print("Part 2", day06_part2("input/input6.txt"))
